    ...
    if(isset($_POST['register'])) {
        ...
        if (count($errors) == 0) {
            ...
            if (mysqli_num_rows($doubleUsername) > 0) {
                ...
                $mail ->setFrom('verify_hyakuya@company.com');
                $mail ->addAddress($email, $username);
                $mail ->Subject = "Please verify Email";
                $mail ->isHTML(true);
                $mail ->Body = "Please click the link below to verify your email: <br><br><a href='http://hyakuya.x10host.com/confirm.php?email=$email&token=$token'>Confirm here</a>";
